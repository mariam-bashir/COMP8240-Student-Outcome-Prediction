...
plt.tight_layout()
plt.savefig("figures/existing_dataset/kfold/with_lasso_boxplot.png", dpi=300, bbox_inches="tight")
plt.show()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig("figures/existing_dataset/kfold/without_lasso_boxplot.png", dpi=300, bbox_inches="tight")
plt.show()
